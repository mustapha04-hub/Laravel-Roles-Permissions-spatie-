              ...
              <div class="p-6 text-gray-900 dark:text-gray-100">
                  <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div>
                      ...
                      <div class="my-3">
                        <input type="password" class="border-gray-300 shadow-sm w-1/2 rounded-lg text-dark-300 text-black"
                      ...
                      <button class="bg-slate-700 text-sm rounded-md hover:bg-slate-600  text-white px-5 py-3">Create</button>
                    </div>
                  </form>
              </div>
          </div>
